 ...
 * and a footer with theme toggle + logout. Hidden on lg+ where the desktop
    ...
    <div className="lg:hidden">
      ...
      >
          ...
          {visibleEntries.map((entry) => {
            ...
            return (
              ...
              >
                ...
                <Icon
                  className={`h-4.5 w-4.5 ${active ? "text-primary-500" : ""}`}
                />
                {entry.name}
              </Link>
            );
        ...
        <div className="flex flex-col gap-1 border-t border-border p-3">
          <button
            onClick={toggleTheme}
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-foreground-muted transition-colors hover:bg-muted"
          >
            {theme === "dark" ? (
              <>
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-danger transition-colors hover:bg-danger-50 dark:hover:bg-danger-900/20"
          >
