---
name: eject-tf
description: "DESTRUCTIVO: Eliminar Titan Factory del proyecto y dejar solo el software funcional. Activar cuando el usuario dice: quiero quitar Titan Factory, eject, remover el template, limpiar el proyecto, o distribuir el codigo sin la fabrica. SIEMPRE confirmar antes de ejecutar."
...
Modifica estos archivos para quitar referencias a Titan Factory:
...
export const metadata: Metadata = {
  title: 'Titan Factory App',
  description: 'Built with Titan Factory',
}
...
No queda rastro de Titan Factory.
```
...
2. **No hay vuelta atras** - Para recuperar TF, tendrias que volver a ejecutar el alias `titan-factory`
