...
// CRITICAL: .trim() prevents invisible whitespace from breaking signature verification
...
// ================================================================
// THIS is where access is granted. NOT in checkout.updated.
// ================================================================
...
async function handleSubscriptionCanceled(subscription: any) {
  ...
  // Check for another active subscription before revoking
  ...
  // Only revoke access if no other active subscriptions
...
// Only links checkout_id. Does NOT grant access.
