...
```typescript
// The core idea: define a Zod schema and the AI fills it in
...
export function useSmartForm<T>({ schema, extractEndpoint }: UseSmartFormOptions<T>) {
  ...
  // The user pastes free text and the AI parses it
...
// Generic schema (customize per case)
const ExtractSchema = z.object({
  // MODIFY: Define your schema here
