...
```typescript
// Conceptual flow:
// 1. User asks: "Show me this month's sales"
// 2. AI decides: "I'll show a SalesChart"
// 3. AI calls tool: render_chart({ type: 'bar', data: [...] })
// 4. You render the component <SalesChart data={...} />
```
...
// Components that the AI can invoke
...
// Each tool represents a component the AI can invoke
